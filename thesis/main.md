...
- **모든 10 decile 에서 통계적으로 유의한 우위**: rank-quantile 분할로 각 decile 표본이 1,163 으로 균등화된 결과, paired win-rate 95% 신뢰구간이 *전 decile 에서 0.5 위에 위치* 한다. corpus 가 거의 모르는 매우 희귀한 영역 (decile 00–10) 에서도, 매우 풍부한 영역 (decile 90–100) 에서도 결합기가 일관되게 환각 후보를 정답 후보보다 더 위험하게 평가한다.
...
J. Phillips et al., “Learning to Predict When Language Models Are Wrong,” *arXiv preprint arXiv:2603.21172*, 2026.
