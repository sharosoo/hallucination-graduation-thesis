...
- **Candidate-row 단위 결합기 비교**. SE / Energy artifact 를 빼고 나면 이 단위에서 GBM (no corpus) 가 candidate-row AUROC 0.541 의 약한 detector 였다. corpus 를 추가한 fusion 이 이 단위에서도 +0.04 정도의 약한 lift 를 보였으나, prompt-level 단위 (+0.060 vs SE, +0.030 vs Energy) 의 강한 결과를 가리는 것이 아니라 더 어려운 단위에서도 corpus signal 의 기여 방향이 일관됨을 시사한다.
...
A. Ravichander, S. Ghela, D. Wadden, and Y. Choi, “HALoGEN: Fantastic LLM Hallucinations and Where to Find Them,” *Proceedings of ACL*, pp. 1402–1425, 2025.
